...
public enum FeetSlotRefs implements EquipmentRefs {
    ...
    AVERNIC_TREADS(
            ...
            levels(DEFENCE, 80, STRENGTH, 80, RANGED, 80, MAGIC, 80)),
    AVERNIC_TREADS_ET(
    ...
    BOOTS_OF_BRIMSTONE(
            ...
            levels(RANGED, 70, DEFENCE, 70, SLAYER, 44, MAGIC, 70)),
    BOOTS_OF_DARKNESS(
    ...
    STEEL_BOOTS(
            ...
            levels(DEFENCE, 5)),
    SWAMP_BARK_BOOTS(
            ArmourItemRef.SWAMP_BARK_BOOTS,
            true,
            new AttackBonus(0, 0, 0, 3, 0),
            ...
            0.907,
            0,
            ArmourItemRef.SWAMP_BARK_BOOTS.getSimilarItems()),
    TEAL_BOOTS(
